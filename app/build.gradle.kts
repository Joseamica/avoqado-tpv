...
dependencies {
    ...
    compileOnly(files("libs/angelpaySDK-v1.0.15-fat-release.aar"))
    "nexgoImplementation"(files("libs/angelpaySDK-v1.0.15-fat-release.aar"))
    "nexgoProdImplementation"(files("libs/angelpaySDK-v1.0.15-fat-release.aar"))
    ...
    testImplementation(files("libs/angelpaySDK-v1.0.15-fat-release.aar"))
