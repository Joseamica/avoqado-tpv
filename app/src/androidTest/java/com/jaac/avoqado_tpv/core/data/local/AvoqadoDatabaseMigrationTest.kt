...
class AvoqadoDatabaseMigrationTest {
    ...
    /**
     * v31 → v32 creates the durable POS→TPV inbox (era 29→30 en `develop`; renumerada al juntar ramas) without touching money already
     ...
     */
    @Test
    fun migrate31To32_preservesPendingMoneyAndCreatesDurableRemoteInbox() {
        ...
        val migrated = helper.runMigrationsAndValidate(TEST_DB, 32, true, AvoqadoDatabase.MIGRATION_31_32)
